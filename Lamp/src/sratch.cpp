...
//---------------------------
    ...
    float rotationAngle;
public:
    Shape(Shader * _shader, Material * _material, Texture * _texture, Geometry * _geometry) :
...
public:
    void Build() {
        ...
        material0->kd = vec3(1.0f, 0.0f, 0.0f);
        material0->kd = vec3(1.0f, 0.0f, 0.0f);
        material0->kd = vec3(1.0f, 0.0f, 0.0f);
        material0->shininess = 100;

        Material * material1 = new Material;
        material1->kd = vec3(1.0f, 0.0f, 0.0f);
        material1->ks = vec3(0.0f, 1.0f, 0.0f);
        material1->ka = vec3(0.0f, 0.0f, 1.0f);
        material1->shininess = 30;

        // Textures
        Texture * texture4x8 = new CheckerBoardTexture(4, 8);
        Texture * texture15x20 = new CheckerBoardTexture(25, 30);
        ...
        Shape * sphereObject1 = new Shape(phongShader, material0, texture15x20, sphere);
        sphereObject1->translation = vec3(-2.1f, 0, 0);
        sphereObject1->scale = vec3(1.0f, 1.0f, 1.0f);
        objects.push_back(sphereObject1);

        // Create objects by setting up their vertex data on the GPU
        Shape * sphereObject2 = new Shape(phongShader, material0, texture15x20, sphere);
        sphereObject2->translation = vec3(0, 0, 0.0);
        sphereObject2->scale = vec3(1.0f, 1.0f, 1.0f);
        objects.push_back(sphereObject2);

        // Create objects by setting up their vertex data on the GPU
        Shape * sphereObject3 = new Shape(phongShader, material0, texture15x20, sphere);
        sphereObject3->translation = vec3(2.1, 0, 0.0);
        sphereObject3->scale = vec3(1.0f, 1.0f, 1.0f);
    ...
    void Animate(float tstart, float tend) {
        for (Shape * obj : objects) obj->Animate(tstart, tend);
    }
};
